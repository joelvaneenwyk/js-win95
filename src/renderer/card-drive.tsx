      ...
      <section>
        <div className="card settings">
          ...
          <div className="card-body">
            <p>
              windows95 (this app) uses a raw disk image. Windows 95 (the operating
              system) is fragile, so adding or removing files is risky.
            </p>
            {advice}
          </div>
        </div>
  ...
  public renderAdviceWindows(): JSX.Element {
    return (
      <fieldset>
        ...
        <p>
          Windows 10 cannot mount raw disk images (ironically, macOS and Linux can).
          However, tools exist that let you mount this drive, like the freeware tool{' '}
          <a
            target="_blank"
  ...
  public renderAdviceMac(): JSX.Element {
    return (
      <fieldset>
        ...
        <p>
          macOS can mount the disk image directly. Click the button below to see the
          disk image in Finder. Then, double-click the image to mount it.
        </p>
  ...
  public renderAdviceLinux(): JSX.Element {
    return (
      <fieldset>
        ...
        <p>
          There are plenty of tools that enable Linux users to mount and modify disk
          images. The disk image used by windows95 is a raw &quot;img&quot; disk
          image and can probably be mounted using the <code>mount</code> tool, which
          is likely installed on your machine.
        </p>
